...
Plug('kkiyama117/coc-toml', { ['do'] = 'yarn install' })
Plug('neoclide/coc.nvim', { branch = 'release' })
Plug('xiyaowong/coc-lightbulb-', { ['do'] = 'yarn install' })
Plug('xiyaowong/coc-sumneko-lua', { ['do'] = 'yarn install' })
Plug('yaegassy/coc-ansible', { ['do'] = 'yarn install' })
Plug('yaegassy/coc-pydocstring', { ['do'] = 'yarn install' })
Plug('yaegassy/coc-pylsp', { ['do'] = 'yarn install' })
Plug('weirongxu/coc-calc', { ['do'] = 'yarn install' })
